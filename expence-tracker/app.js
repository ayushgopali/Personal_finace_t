...
function clearCategoryFilters() {
    ...
    setSpendoraSelectValue('categoryFocus', '');
    setSpendoraSelectValue('categoryPayment', '');
    setSpendoraSelectValue('categorySort', 'amount-desc');
...
function renderCategoryFlowVisual(stats) {
    ...
    container.querySelectorAll('[data-category-quick]').forEach(button => {
        button.addEventListener('click', () => {
            const backButton = document.getElementById('categoryFlowBack');
            setSpendoraSelectValue('categoryFocus', button.dataset.categoryQuick || '');
